...
ostream& operator<<(ostream& os, const Example& eg){
    ...
    os << "enqs:" << endl;
    for (map<cid_t, vector<unsigned int>>::const_iterator it = eg.enqs.begin();
         it != eg.enqs.end(); it++){
        os << it->first << " ";
    ...
    os << "deqs:" << endl;
    for (map<cid_t, vector<unsigned int>>::const_iterator it = eg.deqs.begin();
         it != eg.deqs.end(); it++){
        os << it->first << " ";
        for (unsigned int t = 0; t < it->second.size(); t++){
            os << it->second[t] << " ";
...
void write_examples_to_file(deque<Example*>& examples,
    ...
    for (unsigned int i = 0; i < examples.size(); i++){
        ...
        for (map<cid_t, vector<unsigned int>>::iterator it = eg->enqs.begin();
             it != eg->enqs.end(); it++){
            out << it->first << " ";
            for (unsigned int t = 0; t < it->second.size(); t++){
                out << it->second[t] << " ";
        ...
        for (map<cid_t, vector<unsigned int>>::iterator it = eg->deqs.begin();
             it != eg->deqs.end(); it++){
            out << it->first << " ";
            for (unsigned int t = 0; t < it->second.size(); t++){
                out << it->second[t] << " ";
...
/*
 ...
 qid deq1 deq2 ...
 */
void read_examples_from_file(std::deque<Example*>& examples,
                             std::string fname){
    ifstream in;
    in.open(fname);
