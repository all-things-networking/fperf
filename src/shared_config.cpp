...
Dists::Dists(DistsParams params) {
    ...
    op_dist = std::uniform_int_distribution<unsigned int>(params.op_range_min, params.op_range_max);
...
double Dists::real_zero_to_one() {
    return real_zero_to_one_dist(gen);
}

unsigned int Dists::rhs() {
    return rhs_dist(gen);
}

unsigned int Dists::rhs_const() {
    return rhs_const_dist(gen);
}
unsigned int Dists::rhs_time_coeff() {
    return rhs_time_coeff_dist(gen);
}

unsigned int Dists::trf() {
    return trf_dist(gen);
}
...
unsigned int Dists::input_queue() {
    return input_queue_dist(gen);
}
unsigned int Dists::input_queue_cnt() {
...
unsigned int Dists::timestep() {
    return timestep_dist(gen);
}
unsigned int Dists::enq() {
    return enq_dist(gen);
}

unsigned int Dists::pkt_metric1_val() {
    return pkt_meta1_val_dist(gen);
}
unsigned int Dists::pkt_metric2_val() {
