...
void SwitchXBarQM::add_constrs(NetContext& net_ctx,
...
LeafXBarQM::LeafXBarQM(cid_t id,
                       ...
                       std::vector<QueueInfo> out_queue_info,
                       NetContext& net_ctx):
SwitchXBarQM(id, total_time, voq_input_map, voq_output_map,
             in_queue_info, out_queue_info, net_ctx),
leaf_id(leaf_id),
...
void LeafXBarQM::add_constrs(NetContext& net_ctx, 
                             std::map<std::string, expr>& constr_map){
...
void ReducedLeafXBarQM::add_constrs(NetContext& net_ctx, 
                             std::map<std::string, expr>& constr_map){
    SwitchXBarQM::add_constrs(net_ctx, constr_map);
