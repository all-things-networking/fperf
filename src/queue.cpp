...
void Queue::sliding_window_constrs(NetContext& net_ctx, std::map<std::string, expr>& constr_map) {
...
void Queue::add_constrs(NetContext& net_ctx, std::map<std::string, expr>& constr_map) {
...
Metric* Queue::get_metric(metric_t metric_type) {
    ...
    if (it == metrics.end()) {
        ...
        //        std::cout << "ERROR: " << "queue " << id << " does not have a " << metric_type <<
        //        std::endl;
        return NULL;
    }
...
void Link::add_constrs(NetContext& net_ctx, std::map<std::string, expr>& constr_map) {
